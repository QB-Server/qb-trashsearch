...
Config.RewardsSmall = {
    ...
    [3] = {item = "beer", minAmount = 1, maxAmount = 1},
    [4] = {item = "plastic", minAmount = 1, maxAmount = 4},
    [5] = {item = "rubber", minAmount = 1, maxAmount = 7},
    [6] = {item = "rolex", minAmount = 1, maxAmount = 1},
    [7] = {item = "iron", minAmount = 1, maxAmount = 2},
    [8] = {item = "empty_weed_bag", minAmount = 1, maxAmount = 3},
    [9] = {item = "weed_og-kush", minAmount = 1, maxAmount = 2},
    [10] = {item = "pistol_ammo", minAmount = 1, maxAmount = 2},
}
